        ...
        <br/>
          ...
          <div class="form-group">
            <div class="input-group">
              ...
              <input type="email" name="email" class="form-control alt" id="usr" autocomplete="off" placeholder="<?php echo _('Vaša e-mail adresa'); ?>" required>
            </div>
          </div>

    			<button type="submit" class="login-btn"><?php echo _('Poništi lozinku'); ?></button><br/>

          <p class="text-center">
            <a href="<?php echo $url."/modules/default/login.php"; ?>">&larr; <?php echo _('Nazad na stranicu za prijavu'); ?></a>
          </p>
          ...
          <?php
            ...
            if(isset($_POST['lost'])){
              ...
              $check = $db->query("SELECT * FROM users WHERE email='".$_POST['email']."' LIMIT 0,1");
              if($check->rowCount()>0){
                $row = $check->fetch();
              ...
              if($user != false){
                ...
                if($res->rowCount()==1) {
                  ...
                  $msg = array(
            						...
            						<html>
            							...
            							<body bgcolor='#ebeef3'>
            								<div style='font-family:Arial, Helvetica, sans-serif;font-size:13px;margin:0;padding:30px;'>
            									"._('Poštovani,')." "._('Zatražili ste reset lozinke, nova je u prilogu.')."<br/><br/>
                              "._('Lozinka').": <b>".$generated."</b>
            								</div>
                    ...
                    echo _('E-mail sa uputama je poslan molimo provjerite poruke na email-u koji ste naveli u zahtjevu za reset lozinke.');
                    echo '</div>';
            			}
                ...
                echo _('Unesena e-ail adresa nije pronađena u bazi.');
                echo '</div>';
