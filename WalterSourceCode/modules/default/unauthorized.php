  ...
  <div class="container login">
    ...
    <div class="row">
      <div class="col-sm-6 col-md-4 col-md-offset-4 col-sm-offset-3 unauthorized">
        ...
        <h1><?php echo _('Neovlašten pristup'); ?></h1>
        <?php echo _('Nemate ovlasti za pristup ovom dijelu aplikacije. Ukoliko je doslo do greške, kontaktirajte administratora.'); ?>
        <br/><br/>
        <a class="btn btn-red" href="/"><?php echo _('Nazad na moj profil'); ?><i class="ion-person"></i></a>
