    ...
    <div class="row">
      ...
      <div class="col-sm-7">
        ...
        <?php
          ...
          $query = $db->query("SELECT * FROM countries ".$where." ORDER BY name ASC limit $offset, $limit");
          $get2 = $db->query("SELECT * FROM countries ".$where." ORDER BY name ASC");
          $total = $get2->rowCount();
        ...
        <div class="box clear">
          ...
          <table class="table table-hover">
              ...
              ?>
                  ...
                  <a href="<?php echo $url.'/modules/'.$_mod.'/ajax.php'; ?>" class="table-btn" data-widget="remove" data-id="country:<?php echo $tools_id; ?>" data-text="<?php echo _('Dali ste sigurni da želite brisati:'); ?> <?php echo $item['name']; ?>"><i class="ion-android-close"></i></a>
                </td>
    					</tr>
              <?php } } ?>
    				</tbody>
